...
export function ChartTipoComponente() {
  ...
  const getStat = useCallback(async () => {
    const { data } = await bff.post(
      "/v1/portal/components/stat/ref-component-type",
      {
  ...
  return (
    <Card className="col-span-3 row-span-1">
      <CardHeader>
        <CardTitle>Tipo de componentes</CardTitle>
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <p>
          ...
          indica la cantidad de componentes activos según el tipo de componente.
        </p>
      </CardFooter>
    </Card>
  );
