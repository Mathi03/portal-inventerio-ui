...
export default function Header() {
  ...
  return (
    <header className="px-14 h-[60px] items-center grid grid-cols-[auto_1fr_auto_auto] gap-6 overflow-hidden bg-white sticky top-0 z-[2]">
