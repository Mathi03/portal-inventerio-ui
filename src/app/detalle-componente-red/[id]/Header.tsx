...
export default function Header({
  ...
  return (
    <header className="px-14 h-[60px] items-center grid grid-cols-[auto_auto_1fr_auto_auto] gap-6 overflow-hidden bg-white sticky top-0 col-span-2">
      <IconButton icon="arrow_back_ios" onClick={onNavigate} />
      <img src="/logo.svg" alt="telefonica" className="w-6" />
      <h4 className="text-3xl">
        {componenteRed?.controlLabel} - ({componenteRed?.id}) - ({componenteRed?.controlId})
      </h4>
